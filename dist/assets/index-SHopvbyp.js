...
`)}function Dm(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Xi).join(`
...
}`;function lg(r,e,t){let n=new Wa;const i=new Ue,s=new Ue,a=new je,o=new au({depthPacking:Jc}),l=new ou,c={},h=t.maxTextureSize,u={[Nn]:Lt,[Lt]:Nn,[_n]:_n},d=new Fn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ue},radius:{value:4}},vertexShader:ag,fragmentShader:og}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new Dt;g.setAttribute("position",new Xt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new se(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Tl;let f=this.type;this.render=function(A,R,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const M=r.getRenderTarget(),x=r.getActiveCubeFace(),I=r.getActiveMipmapLevel(),k=r.state;k.setBlending(Ln),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const O=f!==gn&&this.type===gn,G=f===gn&&this.type!==gn;for(let $=0,W=A.length;$<W;$++){const ee=A[$],H=ee.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",ee,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;i.copy(H.mapSize);const re=H.getFrameExtents();if(i.multiply(re),s.copy(H.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/re.x),i.x=s.x*re.x,H.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/re.y),i.y=s.y*re.y,H.mapSize.y=s.y)),H.map===null||O===!0||G===!0){const xe=this.type!==gn?{minFilter:zt,magFilter:zt}:{};H.map!==null&&H.map.dispose(),H.map=new ei(i.x,i.y,xe),H.map.texture.name=ee.name+".shadowMap",H.camera.updateProjectionMatrix()}r.setRenderTarget(H.map),r.clear();const de=H.getViewportCount();for(let xe=0;xe<de;xe++){const ke=H.getViewport(xe);a.set(s.x*ke.x,s.y*ke.y,s.x*ke.z,s.y*ke.w),k.viewport(a),H.updateMatrices(ee,xe),n=H.getFrustum(),S(R,L,H.camera,ee,this.type)}H.isPointLightShadow!==!0&&this.type===gn&&E(H,L),H.needsUpdate=!1}f=this.type,m.needsUpdate=!1,r.setRenderTarget(M,x,I)};function E(A,R){const L=e.update(_);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new ei(i.x,i.y)),d.uniforms.shadow_pass.value=A.map.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,r.setRenderTarget(A.mapPass),r.clear(),r.renderBufferDirect(R,null,L,d,_,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,r.setRenderTarget(A.map),r.clear(),r.renderBufferDirect(R,null,L,p,_,null)}function w(A,R,L,M){let x=null;const I=L.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(I!==void 0)x=I;else if(x=L.isPointLight===!0?l:o,r.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const k=x.uuid,O=R.uuid;let G=c[k];G===void 0&&(G={},c[k]=G);let $=G[O];$===void 0&&($=x.clone(),G[O]=$,R.addEventListener("dispose",P)),x=$}if(x.visible=R.visible,x.wireframe=R.wireframe,M===gn?x.side=R.shadowSide!==null?R.shadowSide:R.side:x.side=R.shadowSide!==null?R.shadowSide:u[R.side],x.alphaMap=R.alphaMap,x.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,x.map=R.map,x.clipShadows=R.clipShadows,x.clippingPlanes=R.clippingPlanes,x.clipIntersection=R.clipIntersection,x.displacementMap=R.displacementMap,x.displacementScale=R.displacementScale,x.displacementBias=R.displacementBias,x.wireframeLinewidth=R.wireframeLinewidth,x.linewidth=R.linewidth,L.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const k=r.properties.get(x);k.light=L}return x}function S(A,R,L,M,x){if(A.visible===!1)return;if(A.layers.test(R.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&x===gn)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,A.matrixWorld);const O=e.update(A),G=A.material;if(Array.isArray(G)){const $=O.groups;for(let W=0,ee=$.length;W<ee;W++){const H=$[W],re=G[H.materialIndex];if(re&&re.visible){const de=w(A,re,M,x);A.onBeforeShadow(r,A,R,L,O,de,H),r.renderBufferDirect(L,null,O,de,A,H),A.onAfterShadow(r,A,R,L,O,de,H)}}}else if(G.visible){const $=w(A,G,M,x);A.onBeforeShadow(r,A,R,L,O,$,null),r.renderBufferDirect(L,null,O,$,A,null),A.onAfterShadow(r,A,R,L,O,$,null)}}const k=A.children;for(let O=0,G=k.length;O<G;O++)S(k[O],R,L,M,x)}function P(A){A.target.removeEventListener("dispose",P);for(const L in c){const M=c[L],x=A.target.uuid;x in M&&(M[x].dispose(),delete M[x])}}}const cg={[Hr]:Gr,[Wr]:Yr,[Xr]:Kr,[Ei]:qr,[Gr]:Hr,[Yr]:Wr,[Kr]:Xr,[qr]:Ei};function hg(r,e){function t(){let D=!1;const le=new je;let V=null;const Z=new je(0,0,0,0);return{setMask:function(he){V!==he&&!D&&(r.colorMask(he,he,he,he),V=he)},setLocked:function(he){D=he},setClear:function(he,ce,Ne,dt,Mt){Mt===!0&&(he*=dt,ce*=dt,Ne*=dt),le.set(he,ce,Ne,dt),Z.equals(le)===!1&&(r.clearColor(he,ce,Ne,dt),Z.copy(le))},reset:function(){D=!1,V=null,Z.set(-1,0,0,0)}}}function n(){let D=!1,le=!1,V=null,Z=null,he=null;return{setReversed:function(ce){if(le!==ce){const Ne=e.get("EXT_clip_control");ce?Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.ZERO_TO_ONE_EXT):Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.NEGATIVE_ONE_TO_ONE_EXT),le=ce;const dt=he;he=null,this.setClear(dt)}},getReversed:function(){return le},setTest:function(ce){ce?ae(r.DEPTH_TEST):we(r.DEPTH_TEST)},setMask:function(ce){V!==ce&&!D&&(r.depthMask(ce),V=ce)},setFunc:function(ce){if(le&&(ce=cg[ce]),Z!==ce){switch(ce){case Hr:r.depthFunc(r.NEVER);break;case Gr:r.depthFunc(r.ALWAYS);break;case Wr:r.depthFunc(r.LESS);break;case Ei:r.depthFunc(r.LEQUAL);break;case Xr:r.depthFunc(r.EQUAL);break;case qr:r.depthFunc(r.GEQUAL);break;case Yr:r.depthFunc(r.GREATER);break;case Kr:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Z=ce}},setLocked:function(ce){D=ce},setClear:function(ce){he!==ce&&(le&&(ce=1-ce),r.clearDepth(ce),he=ce)},reset:function(){D=!1,V=null,Z=null,he=null,le=!1}}}function i(){let D=!1,le=null,V=null,Z=null,he=null,ce=null,Ne=null,dt=null,Mt=null;return{setTest:function(et){D||(et?ae(r.STENCIL_TEST):we(r.STENCIL_TEST))},setMask:function(et){le!==et&&!D&&(r.stencilMask(et),le=et)},setFunc:function(et,qt,cn){(V!==et||Z!==qt||he!==cn)&&(r.stencilFunc(et,qt,cn),V=et,Z=qt,he=cn)},setOp:function(et,qt,cn){(ce!==et||Ne!==qt||dt!==cn)&&(r.stencilOp(et,qt,cn),ce=et,Ne=qt,dt=cn)},setLocked:function(et){D=et},setClear:function(et){Mt!==et&&(r.clearStencil(et),Mt=et)},reset:function(){D=!1,le=null,V=null,Z=null,he=null,ce=null,Ne=null,dt=null,Mt=null}}}const s=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,E=null,w=null,S=null,P=null,A=null,R=new De(0,0,0),L=0,M=!1,x=null,I=null,k=null,O=null,G=null;const $=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,ee=0;const H=r.getParameter(r.VERSION);H.indexOf("WebGL")!==-1?(ee=parseFloat(/^WebGL (\d)/.exec(H)[1]),W=ee>=1):H.indexOf("OpenGL ES")!==-1&&(ee=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),W=ee>=2);let re=null,de={};const xe=r.getParameter(r.SCISSOR_BOX),ke=r.getParameter(r.VIEWPORT),st=new je().fromArray(xe),Y=new je().fromArray(ke);function te(D,le,V,Z){const he=new Uint8Array(4),ce=r.createTexture();r.bindTexture(D,ce),r.texParameteri(D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(D,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Ne=0;Ne<V;Ne++)D===r.TEXTURE_3D||D===r.TEXTURE_2D_ARRAY?r.texImage3D(le,0,r.RGBA,1,1,Z,0,r.RGBA,r.UNSIGNED_BYTE,he):r.texImage2D(le+Ne,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,he);return ce}const ge={};ge[r.TEXTURE_2D]=te(r.TEXTURE_2D,r.TEXTURE_2D,1),ge[r.TEXTURE_CUBE_MAP]=te(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),ge[r.TEXTURE_2D_ARRAY]=te(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),ge[r.TEXTURE_3D]=te(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ae(r.DEPTH_TEST),a.setFunc(Ei),qe(!1),We(so),ae(r.CULL_FACE),C(Ln);function ae(D){h[D]!==!0&&(r.enable(D),h[D]=!0)}function we(D){h[D]!==!1&&(r.disable(D),h[D]=!1)}function $e(D,le){return u[D]!==le?(r.bindFramebuffer(D,le),u[D]=le,D===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=le),D===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=le),!0):!1}function Re(D,le){let V=p,Z=!1;if(D){V=d.get(le),V===void 0&&(V=[],d.set(le,V));const he=D.textures;if(V.length!==he.length||V[0]!==r.COLOR_ATTACHMENT0){for(let ce=0,Ne=he.length;ce<Ne;ce++)V[ce]=r.COLOR_ATTACHMENT0+ce;V.length=he.length,Z=!0}}else V[0]!==r.BACK&&(V[0]=r.BACK,Z=!0);Z&&r.drawBuffers(V)}function pt(D){return g!==D?(r.useProgram(D),g=D,!0):!1}const ct={[Yn]:r.FUNC_ADD,[Mc]:r.FUNC_SUBTRACT,[wc]:r.FUNC_REVERSE_SUBTRACT};ct[Ec]=r.MIN,ct[bc]=r.MAX;const Ge={[Tc]:r.ZERO,[Ac]:r.ONE,[Rc]:r.SRC_COLOR,[kr]:r.SRC_ALPHA,[Uc]:r.SRC_ALPHA_SATURATE,[Lc]:r.DST_COLOR,[Pc]:r.DST_ALPHA,[Cc]:r.ONE_MINUS_SRC_COLOR,[Vr]:r.ONE_MINUS_SRC_ALPHA,[Dc]:r.ONE_MINUS_DST_COLOR,[Ic]:r.ONE_MINUS_DST_ALPHA,[Nc]:r.CONSTANT_COLOR,[Fc]:r.ONE_MINUS_CONSTANT_COLOR,[Bc]:r.CONSTANT_ALPHA,[Oc]:r.ONE_MINUS_CONSTANT_ALPHA};function C(D,le,V,Z,he,ce,Ne,dt,Mt,et){if(D===Ln){_===!0&&(we(r.BLEND),_=!1);return}if(_===!1&&(ae(r.BLEND),_=!0),D!==Sc){if(D!==m||et!==M){if((f!==Yn||S!==Yn)&&(r.blendEquation(r.FUNC_ADD),f=Yn,S=Yn),et)switch(D){case Mi:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ot:r.blendFunc(r.ONE,r.ONE);break;case ro:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case ao:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Mi:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ot:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case ro:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case ao:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}E=null,w=null,P=null,A=null,R.set(0,0,0),L=0,m=D,M=et}return}he=he||le,ce=ce||V,Ne=Ne||Z,(le!==f||he!==S)&&(r.blendEquationSeparate(ct[le],ct[he]),f=le,S=he),(V!==E||Z!==w||ce!==P||Ne!==A)&&(r.blendFuncSeparate(Ge[V],Ge[Z],Ge[ce],Ge[Ne]),E=V,w=Z,P=ce,A=Ne),(dt.equals(R)===!1||Mt!==L)&&(r.blendColor(dt.r,dt.g,dt.b,Mt),R.copy(dt),L=Mt),m=D,M=!1}function kt(D,le){D.side===_n?we(r.CULL_FACE):ae(r.CULL_FACE);let V=D.side===Lt;le&&(V=!V),qe(V),D.blending===Mi&&D.transparent===!1?C(Ln):C(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),s.setMask(D.colorWrite);const Z=D.stencilWrite;o.setTest(Z),Z&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),at(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ae(r.SAMPLE_ALPHA_TO_COVERAGE):we(r.SAMPLE_ALPHA_TO_COVERAGE)}function qe(D){x!==D&&(D?r.frontFace(r.CW):r.frontFace(r.CCW),x=D)}function We(D){D!==vc?(ae(r.CULL_FACE),D!==I&&(D===so?r.cullFace(r.BACK):D===xc?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):we(r.CULL_FACE),I=D}function ye(D){D!==k&&(W&&r.lineWidth(D),k=D)}function at(D,le,V){D?(ae(r.POLYGON_OFFSET_FILL),(O!==le||G!==V)&&(r.polygonOffset(le,V),O=le,G=V)):we(r.POLYGON_OFFSET_FILL)}function ve(D){D?ae(r.SCISSOR_TEST):we(r.SCISSOR_TEST)}function b(D){D===void 0&&(D=r.TEXTURE0+$-1),re!==D&&(r.activeTexture(D),re=D)}function v(D,le,V){V===void 0&&(re===null?V=r.TEXTURE0+$-1:V=re);let Z=de[V];Z===void 0&&(Z={type:void 0,texture:void 0},de[V]=Z),(Z.type!==D||Z.texture!==le)&&(re!==V&&(r.activeTexture(V),re=V),r.bindTexture(D,le||ge[D]),Z.type=D,Z.texture=le)}function F(){const D=de[re];D!==void 0&&D.type!==void 0&&(r.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function K(){try{r.compressedTexImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function j(){try{r.compressedTexImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function X(){try{r.texSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function _e(){try{r.texSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function oe(){try{r.compressedTexSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ee(){try{r.compressedTexSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Te(){try{r.texStorage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function J(){try{r.texStorage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function fe(){try{r.texImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ae(){try{r.texImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ie(D){st.equals(D)===!1&&(r.scissor(D.x,D.y,D.z,D.w),st.copy(D))}function pe(D){Y.equals(D)===!1&&(r.viewport(D.x,D.y,D.z,D.w),Y.copy(D))}function Xe(D,le){let V=c.get(le);V===void 0&&(V=new WeakMap,c.set(le,V));let Z=V.get(D);Z===void 0&&(Z=r.getUniformBlockIndex(le,D.name),V.set(D,Z))}function Be(D,le){const Z=c.get(le).get(D);l.get(le)!==Z&&(r.uniformBlockBinding(le,Z,D.__bindingPointIndex),l.set(le,Z))}function rt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},re=null,de={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,E=null,w=null,S=null,P=null,A=null,R=new De(0,0,0),L=0,M=!1,x=null,I=null,k=null,O=null,G=null,st.set(0,0,r.canvas.width,r.canvas.height),Y.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ae,disable:we,bindFramebuffer:$e,drawBuffers:Re,useProgram:pt,setBlending:C,setMaterial:kt,setFlipSided:qe,setCullFace:We,setLineWidth:ye,setPolygonOffset:at,setScissorTest:ve,activeTexture:b,bindTexture:v,unbindTexture:F,compressedTexImage2D:K,compressedTexImage3D:j,texImage2D:fe,texImage3D:Ae,updateUBOMapping:Xe,uniformBlockBinding:Be,texStorage2D:Te,texStorage3D:J,texSubImage2D:X,texSubImage3D:_e,compressedTexSubImage2D:oe,compressedTexSubImage3D:Ee,scissor:Ie,viewport:pe,reset:rt}}function ug(r,e,t,n,i,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ue,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(b,v){return p?new OffscreenCanvas(b,v):Ji("canvas")}function _(b,v,F){let K=1;const j=ve(b);if((j.width>F||j.height>F)&&(K=F/Math.max(j.width,j.height)),K<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const X=Math.floor(K*j.width),_e=Math.floor(K*j.height);u===void 0&&(u=g(X,_e));const oe=v?g(X,_e):u;return oe.width=X,oe.height=_e,oe.getContext("2d").drawImage(b,0,0,X,_e),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+X+"x"+_e+")."),oe}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),b;return b}function m(b){return b.generateMipmaps}function f(b){r.generateMipmap(b)}function E(b){return b.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?r.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function w(b,v,F,K,j=!1){if(b!==null){if(r[b]!==void 0)return r[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let X=v;if(v===r.RED&&(F===r.FLOAT&&(X=r.R32F),F===r.HALF_FLOAT&&(X=r.R16F),F===r.UNSIGNED_BYTE&&(X=r.R8)),v===r.RED_INTEGER&&(F===r.UNSIGNED_BYTE&&(X=r.R8UI),F===r.UNSIGNED_SHORT&&(X=r.R16UI),F===r.UNSIGNED_INT&&(X=r.R32UI),F===r.BYTE&&(X=r.R8I),F===r.SHORT&&(X=r.R16I),F===r.INT&&(X=r.R32I)),v===r.RG&&(F===r.FLOAT&&(X=r.RG32F),F===r.HALF_FLOAT&&(X=r.RG16F),F===r.UNSIGNED_BYTE&&(X=r.RG8)),v===r.RG_INTEGER&&(F===r.UNSIGNED_BYTE&&(X=r.RG8UI),F===r.UNSIGNED_SHORT&&(X=r.RG16UI),F===r.UNSIGNED_INT&&(X=r.RG32UI),F===r.BYTE&&(X=r.RG8I),F===r.SHORT&&(X=r.RG16I),F===r.INT&&(X=r.RG32I)),v===r.RGB_INTEGER&&(F===r.UNSIGNED_BYTE&&(X=r.RGB8UI),F===r.UNSIGNED_SHORT&&(X=r.RGB16UI),F===r.UNSIGNED_INT&&(X=r.RGB32UI),F===r.BYTE&&(X=r.RGB8I),F===r.SHORT&&(X=r.RGB16I),F===r.INT&&(X=r.RGB32I)),v===r.RGBA_INTEGER&&(F===r.UNSIGNED_BYTE&&(X=r.RGBA8UI),F===r.UNSIGNED_SHORT&&(X=r.RGBA16UI),F===r.UNSIGNED_INT&&(X=r.RGBA32UI),F===r.BYTE&&(X=r.RGBA8I),F===r.SHORT&&(X=r.RGBA16I),F===r.INT&&(X=r.RGBA32I)),v===r.RGB&&F===r.UNSIGNED_INT_5_9_9_9_REV&&(X=r.RGB9_E5),v===r.RGBA){const _e=j?Gs:Ze.getTransfer(K);F===r.FLOAT&&(X=r.RGBA32F),F===r.HALF_FLOAT&&(X=r.RGBA16F),F===r.UNSIGNED_BYTE&&(X=_e===it?r.SRGB8_ALPHA8:r.RGBA8),F===r.UNSIGNED_SHORT_4_4_4_4&&(X=r.RGBA4),F===r.UNSIGNED_SHORT_5_5_5_1&&(X=r.RGB5_A1)}return(X===r.R16F||X===r.R32F||X===r.RG16F||X===r.RG32F||X===r.RGBA16F||X===r.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function S(b,v){let F;return b?v===null||v===Qn||v===Zi?F=r.DEPTH24_STENCIL8:v===Qt?F=r.DEPTH32F_STENCIL8:v===Ki&&(F=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Qn||v===Zi?F=r.DEPTH_COMPONENT24:v===Qt?F=r.DEPTH_COMPONENT32F:v===Ki&&(F=r.DEPTH_COMPONENT16),F}function P(b,v){return m(b)===!0||b.isFramebufferTexture&&b.minFilter!==zt&&b.minFilter!==rn?Math.log2(Math.max(v.width,v.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?v.mipmaps.length:1}function A(b){const v=b.target;v.removeEventListener("dispose",A),L(v),v.isVideoTexture&&h.delete(v)}function R(b){const v=b.target;v.removeEventListener("dispose",R),x(v)}function L(b){const v=n.get(b);if(v.__webglInit===void 0)return;const F=b.source,K=d.get(F);if(K){const j=K[v.__cacheKey];j.usedTimes--,j.usedTimes===0&&M(b),Object.keys(K).length===0&&d.delete(F)}n.remove(b)}function M(b){const v=n.get(b);r.deleteTexture(v.__webglTexture);const F=b.source,K=d.get(F);delete K[v.__cacheKey],a.memory.textures--}function x(b){const v=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(v.__webglFramebuffer[K]))for(let j=0;j<v.__webglFramebuffer[K].length;j++)r.deleteFramebuffer(v.__webglFramebuffer[K][j]);else r.deleteFramebuffer(v.__webglFramebuffer[K]);v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer[K])}else{if(Array.isArray(v.__webglFramebuffer))for(let K=0;K<v.__webglFramebuffer.length;K++)r.deleteFramebuffer(v.__webglFramebuffer[K]);else r.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&r.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let K=0;K<v.__webglColorRenderbuffer.length;K++)v.__webglColorRenderbuffer[K]&&r.deleteRenderbuffer(v.__webglColorRenderbuffer[K]);v.__webglDepthRenderbuffer&&r.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const F=b.textures;for(let K=0,j=F.length;K<j;K++){const X=n.get(F[K]);X.__webglTexture&&(r.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(F[K])}n.remove(b)}let I=0;function k(){I=0}function O(){const b=I;return b>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+i.maxTextures),I+=1,b}function G(b){const v=[];return v.push(b.wrapS),v.push(b.wrapT),v.push(b.wrapR||0),v.push(b.magFilter),v.push(b.minFilter),v.push(b.anisotropy),v.push(b.internalFormat),v.push(b.format),v.push(b.type),v.push(b.generateMipmaps),v.push(b.premultiplyAlpha),v.push(b.flipY),v.push(b.unpackAlignment),v.push(b.colorSpace),v.join()}function $(b,v){const F=n.get(b);if(b.isVideoTexture&&ye(b),b.isRenderTargetTexture===!1&&b.version>0&&F.__version!==b.version){const K=b.image;if(K===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(F,b,v);return}}t.bindTexture(r.TEXTURE_2D,F.__webglTexture,r.TEXTURE0+v)}function W(b,v){const F=n.get(b);if(b.version>0&&F.__version!==b.version){Y(F,b,v);return}t.bindTexture(r.TEXTURE_2D_ARRAY,F.__webglTexture,r.TEXTURE0+v)}function ee(b,v){const F=n.get(b);if(b.version>0&&F.__version!==b.version){Y(F,b,v);return}t.bindTexture(r.TEXTURE_3D,F.__webglTexture,r.TEXTURE0+v)}function H(b,v){const F=n.get(b);if(b.version>0&&F.__version!==b.version){te(F,b,v);return}t.bindTexture(r.TEXTURE_CUBE_MAP,F.__webglTexture,r.TEXTURE0+v)}const re={[jr]:r.REPEAT,[Zn]:r.CLAMP_TO_EDGE,[Jr]:r.MIRRORED_REPEAT},de={[zt]:r.NEAREST,[Kc]:r.NEAREST_MIPMAP_NEAREST,[rs]:r.NEAREST_MIPMAP_LINEAR,[rn]:r.LINEAR,[rr]:r.LINEAR_MIPMAP_NEAREST,[$n]:r.LINEAR_MIPMAP_LINEAR},xe={[eh]:r.NEVER,[ah]:r.ALWAYS,[th]:r.LESS,[zl]:r.LEQUAL,[nh]:r.EQUAL,[rh]:r.GEQUAL,[ih]:r.GREATER,[sh]:r.NOTEQUAL};function ke(b,v){if(v.type===Qt&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===rn||v.magFilter===rr||v.magFilter===rs||v.magFilter===$n||v.minFilter===rn||v.minFilter===rr||v.minFilter===rs||v.minFilter===$n)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(b,r.TEXTURE_WRAP_S,re[v.wrapS]),r.texParameteri(b,r.TEXTURE_WRAP_T,re[v.wrapT]),(b===r.TEXTURE_3D||b===r.TEXTURE_2D_ARRAY)&&r.texParameteri(b,r.TEXTURE_WRAP_R,re[v.wrapR]),r.texParameteri(b,r.TEXTURE_MAG_FILTER,de[v.magFilter]),r.texParameteri(b,r.TEXTURE_MIN_FILTER,de[v.minFilter]),v.compareFunction&&(r.texParameteri(b,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(b,r.TEXTURE_COMPARE_FUNC,xe[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===zt||v.minFilter!==rs&&v.minFilter!==$n||v.type===Qt&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");r.texParameterf(b,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,i.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function st(b,v){let F=!1;b.__webglInit===void 0&&(b.__webglInit=!0,v.addEventListener("dispose",A));const K=v.source;let j=d.get(K);j===void 0&&(j={},d.set(K,j));const X=G(v);if(X!==b.__cacheKey){j[X]===void 0&&(j[X]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,F=!0),j[X].usedTimes++;const _e=j[b.__cacheKey];_e!==void 0&&(j[b.__cacheKey].usedTimes--,_e.usedTimes===0&&M(v)),b.__cacheKey=X,b.__webglTexture=j[X].texture}return F}function Y(b,v,F){let K=r.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(K=r.TEXTURE_2D_ARRAY),v.isData3DTexture&&(K=r.TEXTURE_3D);const j=st(b,v),X=v.source;t.bindTexture(K,b.__webglTexture,r.TEXTURE0+F);const _e=n.get(X);if(X.version!==_e.__version||j===!0){t.activeTexture(r.TEXTURE0+F);const oe=Ze.getPrimaries(Ze.workingColorSpace),Ee=v.colorSpace===Pn?null:Ze.getPrimaries(v.colorSpace),Te=v.colorSpace===Pn||oe===Ee?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);let J=_(v.image,!1,i.maxTextureSize);J=at(v,J);const fe=s.convert(v.format,v.colorSpace),Ae=s.convert(v.type);let Ie=w(v.internalFormat,fe,Ae,v.colorSpace,v.isVideoTexture);ke(K,v);let pe;const Xe=v.mipmaps,Be=v.isVideoTexture!==!0,rt=_e.__version===void 0||j===!0,D=X.dataReady,le=P(v,J);if(v.isDepthTexture)Ie=S(v.format===ji,v.type),rt&&(Be?t.texStorage2D(r.TEXTURE_2D,1,Ie,J.width,J.height):t.texImage2D(r.TEXTURE_2D,0,Ie,J.width,J.height,0,fe,Ae,null));else if(v.isDataTexture)if(Xe.length>0){Be&&rt&&t.texStorage2D(r.TEXTURE_2D,le,Ie,Xe[0].width,Xe[0].height);for(let V=0,Z=Xe.length;V<Z;V++)pe=Xe[V],Be?D&&t.texSubImage2D(r.TEXTURE_2D,V,0,0,pe.width,pe.height,fe,Ae,pe.data):t.texImage2D(r.TEXTURE_2D,V,Ie,pe.width,pe.height,0,fe,Ae,pe.data);v.generateMipmaps=!1}else Be?(rt&&t.texStorage2D(r.TEXTURE_2D,le,Ie,J.width,J.height),D&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,J.width,J.height,fe,Ae,J.data)):t.texImage2D(r.TEXTURE_2D,0,Ie,J.width,J.height,0,fe,Ae,J.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Be&&rt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,le,Ie,Xe[0].width,Xe[0].height,J.depth);for(let V=0,Z=Xe.length;V<Z;V++)if(pe=Xe[V],v.format!==Wt)if(fe!==null)if(Be){if(D)if(v.layerUpdates.size>0){const he=Jo(pe.width,pe.height,v.format,v.type);for(const ce of v.layerUpdates){const Ne=pe.data.subarray(ce*he/pe.data.BYTES_PER_ELEMENT,(ce+1)*he/pe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,V,0,0,ce,pe.width,pe.height,1,fe,Ne)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,V,0,0,0,pe.width,pe.height,J.depth,fe,pe.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,V,Ie,pe.width,pe.height,J.depth,0,pe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Be?D&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,V,0,0,0,pe.width,pe.height,J.depth,fe,Ae,pe.data):t.texImage3D(r.TEXTURE_2D_ARRAY,V,Ie,pe.width,pe.height,J.depth,0,fe,Ae,pe.data)}else{Be&&rt&&t.texStorage2D(r.TEXTURE_2D,le,Ie,Xe[0].width,Xe[0].height);for(let V=0,Z=Xe.length;V<Z;V++)pe=Xe[V],v.format!==Wt?fe!==null?Be?D&&t.compressedTexSubImage2D(r.TEXTURE_2D,V,0,0,pe.width,pe.height,fe,pe.data):t.compressedTexImage2D(r.TEXTURE_2D,V,Ie,pe.width,pe.height,0,pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Be?D&&t.texSubImage2D(r.TEXTURE_2D,V,0,0,pe.width,pe.height,fe,Ae,pe.data):t.texImage2D(r.TEXTURE_2D,V,Ie,pe.width,pe.height,0,fe,Ae,pe.data)}else if(v.isDataArrayTexture)if(Be){if(rt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,le,Ie,J.width,J.height,J.depth),D)if(v.layerUpdates.size>0){const V=Jo(J.width,J.height,v.format,v.type);for(const Z of v.layerUpdates){const he=J.data.subarray(Z*V/J.data.BYTES_PER_ELEMENT,(Z+1)*V/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,Z,J.width,J.height,1,fe,Ae,he)}v.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,fe,Ae,J.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Ie,J.width,J.height,J.depth,0,fe,Ae,J.data);else if(v.isData3DTexture)Be?(rt&&t.texStorage3D(r.TEXTURE_3D,le,Ie,J.width,J.height,J.depth),D&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,fe,Ae,J.data)):t.texImage3D(r.TEXTURE_3D,0,Ie,J.width,J.height,J.depth,0,fe,Ae,J.data);else if(v.isFramebufferTexture){if(rt)if(Be)t.texStorage2D(r.TEXTURE_2D,le,Ie,J.width,J.height);else{let V=J.width,Z=J.height;for(let he=0;he<le;he++)t.texImage2D(r.TEXTURE_2D,he,Ie,V,Z,0,fe,Ae,null),V>>=1,Z>>=1}}else if(Xe.length>0){if(Be&&rt){const V=ve(Xe[0]);t.texStorage2D(r.TEXTURE_2D,le,Ie,V.width,V.height)}for(let V=0,Z=Xe.length;V<Z;V++)pe=Xe[V],Be?D&&t.texSubImage2D(r.TEXTURE_2D,V,0,0,fe,Ae,pe):t.texImage2D(r.TEXTURE_2D,V,Ie,fe,Ae,pe);v.generateMipmaps=!1}else if(Be){if(rt){const V=ve(J);t.texStorage2D(r.TEXTURE_2D,le,Ie,V.width,V.height)}D&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,fe,Ae,J)}else t.texImage2D(r.TEXTURE_2D,0,Ie,fe,Ae,J);m(v)&&f(K),_e.__version=X.version,v.onUpdate&&v.onUpdate(v)}b.__version=v.version}function te(b,v,F){if(v.image.length!==6)return;const K=st(b,v),j=v.source;t.bindTexture(r.TEXTURE_CUBE_MAP,b.__webglTexture,r.TEXTURE0+F);const X=n.get(j);if(j.version!==X.__version||K===!0){t.activeTexture(r.TEXTURE0+F);const _e=Ze.getPrimaries(Ze.workingColorSpace),oe=v.colorSpace===Pn?null:Ze.getPrimaries(v.colorSpace),Ee=v.colorSpace===Pn||_e===oe?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const Te=v.isCompressedTexture||v.image[0].isCompressedTexture,J=v.image[0]&&v.image[0].isDataTexture,fe=[];for(let Z=0;Z<6;Z++)!Te&&!J?fe[Z]=_(v.image[Z],!0,i.maxCubemapSize):fe[Z]=J?v.image[Z].image:v.image[Z],fe[Z]=at(v,fe[Z]);const Ae=fe[0],Ie=s.convert(v.format,v.colorSpace),pe=s.convert(v.type),Xe=w(v.internalFormat,Ie,pe,v.colorSpace),Be=v.isVideoTexture!==!0,rt=X.__version===void 0||K===!0,D=j.dataReady;let le=P(v,Ae);ke(r.TEXTURE_CUBE_MAP,v);let V;if(Te){Be&&rt&&t.texStorage2D(r.TEXTURE_CUBE_MAP,le,Xe,Ae.width,Ae.height);for(let Z=0;Z<6;Z++){V=fe[Z].mipmaps;for(let he=0;he<V.length;he++){const ce=V[he];v.format!==Wt?Ie!==null?Be?D&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he,0,0,ce.width,ce.height,Ie,ce.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he,Xe,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Be?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he,0,0,ce.width,ce.height,Ie,pe,ce.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he,Xe,ce.width,ce.height,0,Ie,pe,ce.data)}}}else{if(V=v.mipmaps,Be&&rt){V.length>0&&le++;const Z=ve(fe[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,le,Xe,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(J){Be?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,fe[Z].width,fe[Z].height,Ie,pe,fe[Z].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Xe,fe[Z].width,fe[Z].height,0,Ie,pe,fe[Z].data);for(let he=0;he<V.length;he++){const Ne=V[he].image[Z].image;Be?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he+1,0,0,Ne.width,Ne.height,Ie,pe,Ne.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he+1,Xe,Ne.width,Ne.height,0,Ie,pe,Ne.data)}}else{Be?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Ie,pe,fe[Z]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Xe,Ie,pe,fe[Z]);for(let he=0;he<V.length;he++){const ce=V[he];Be?D&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he+1,0,0,Ie,pe,ce.image[Z]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he+1,Xe,Ie,pe,ce.image[Z])}}}m(v)&&f(r.TEXTURE_CUBE_MAP),X.__version=j.version,v.onUpdate&&v.onUpdate(v)}b.__version=v.version}function ge(b,v,F,K,j,X){const _e=s.convert(F.format,F.colorSpace),oe=s.convert(F.type),Ee=w(F.internalFormat,_e,oe,F.colorSpace),Te=n.get(v),J=n.get(F);if(J.__renderTarget=v,!Te.__hasExternalTextures){const fe=Math.max(1,v.width>>X),Ae=Math.max(1,v.height>>X);j===r.TEXTURE_3D||j===r.TEXTURE_2D_ARRAY?t.texImage3D(j,X,Ee,fe,Ae,v.depth,0,_e,oe,null):t.texImage2D(j,X,Ee,fe,Ae,0,_e,oe,null)}t.bindFramebuffer(r.FRAMEBUFFER,b),We(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,K,j,J.__webglTexture,0,qe(v)):(j===r.TEXTURE_2D||j>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,K,j,J.__webglTexture,X),t.bindFramebuffer(r.FRAMEBUFFER,null)}function ae(b,v,F){if(r.bindRenderbuffer(r.RENDERBUFFER,b),v.depthBuffer){const K=v.depthTexture,j=K&&K.isDepthTexture?K.type:null,X=S(v.stencilBuffer,j),_e=v.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,oe=qe(v);We(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,oe,X,v.width,v.height):F?r.renderbufferStorageMultisample(r.RENDERBUFFER,oe,X,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,X,v.width,v.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,_e,r.RENDERBUFFER,b)}else{const K=v.textures;for(let j=0;j<K.length;j++){const X=K[j],_e=s.convert(X.format,X.colorSpace),oe=s.convert(X.type),Ee=w(X.internalFormat,_e,oe,X.colorSpace),Te=qe(v);F&&We(v)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Te,Ee,v.width,v.height):We(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Te,Ee,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,Ee,v.width,v.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function we(b,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,b),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=n.get(v.depthTexture);K.__renderTarget=v,(!K.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),$(v.depthTexture,0);const j=K.__webglTexture,X=qe(v);if(v.depthTexture.format===$i)We(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,j,0,X):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,j,0);else if(v.depthTexture.format===ji)We(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,j,0,X):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function $e(b){const v=n.get(b),F=b.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==b.depthTexture){const K=b.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),K){const j=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,K.removeEventListener("dispose",j)};K.addEventListener("dispose",j),v.__depthDisposeCallback=j}v.__boundDepthTexture=K}if(b.depthTexture&&!v.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");const K=b.texture.mipmaps;K&&K.length>0?we(v.__webglFramebuffer[0],b):we(v.__webglFramebuffer,b)}else if(F){v.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[K]),v.__webglDepthbuffer[K]===void 0)v.__webglDepthbuffer[K]=r.createRenderbuffer(),ae(v.__webglDepthbuffer[K],b,!1);else{const j=b.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,X=v.__webglDepthbuffer[K];r.bindRenderbuffer(r.RENDERBUFFER,X),r.framebufferRenderbuffer(r.FRAMEBUFFER,j,r.RENDERBUFFER,X)}}else{const K=b.texture.mipmaps;if(K&&K.length>0?t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=r.createRenderbuffer(),ae(v.__webglDepthbuffer,b,!1);else{const j=b.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,X=v.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,X),r.framebufferRenderbuffer(r.FRAMEBUFFER,j,r.RENDERBUFFER,X)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function Re(b,v,F){const K=n.get(b);v!==void 0&&ge(K.__webglFramebuffer,b,b.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),F!==void 0&&$e(b)}function pt(b){const v=b.texture,F=n.get(b),K=n.get(v);b.addEventListener("dispose",R);const j=b.textures,X=b.isWebGLCubeRenderTarget===!0,_e=j.length>1;if(_e||(K.__webglTexture===void 0&&(K.__webglTexture=r.createTexture()),K.__version=v.version,a.memory.textures++),X){F.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer[oe]=[];for(let Ee=0;Ee<v.mipmaps.length;Ee++)F.__webglFramebuffer[oe][Ee]=r.createFramebuffer()}else F.__webglFramebuffer[oe]=r.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer=[];for(let oe=0;oe<v.mipmaps.length;oe++)F.__webglFramebuffer[oe]=r.createFramebuffer()}else F.__webglFramebuffer=r.createFramebuffer();if(_e)for(let oe=0,Ee=j.length;oe<Ee;oe++){const Te=n.get(j[oe]);Te.__webglTexture===void 0&&(Te.__webglTexture=r.createTexture(),a.memory.textures++)}if(b.samples>0&&We(b)===!1){F.__webglMultisampledFramebuffer=r.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let oe=0;oe<j.length;oe++){const Ee=j[oe];F.__webglColorRenderbuffer[oe]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,F.__webglColorRenderbuffer[oe]);const Te=s.convert(Ee.format,Ee.colorSpace),J=s.convert(Ee.type),fe=w(Ee.internalFormat,Te,J,Ee.colorSpace,b.isXRRenderTarget===!0),Ae=qe(b);r.renderbufferStorageMultisample(r.RENDERBUFFER,Ae,fe,b.width,b.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+oe,r.RENDERBUFFER,F.__webglColorRenderbuffer[oe])}r.bindRenderbuffer(r.RENDERBUFFER,null),b.depthBuffer&&(F.__webglDepthRenderbuffer=r.createRenderbuffer(),ae(F.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(X){t.bindTexture(r.TEXTURE_CUBE_MAP,K.__webglTexture),ke(r.TEXTURE_CUBE_MAP,v);for(let oe=0;oe<6;oe++)if(v.mipmaps&&v.mipmaps.length>0)for(let Ee=0;Ee<v.mipmaps.length;Ee++)ge(F.__webglFramebuffer[oe][Ee],b,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee);else ge(F.__webglFramebuffer[oe],b,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);m(v)&&f(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let oe=0,Ee=j.length;oe<Ee;oe++){const Te=j[oe],J=n.get(Te);t.bindTexture(r.TEXTURE_2D,J.__webglTexture),ke(r.TEXTURE_2D,Te),ge(F.__webglFramebuffer,b,Te,r.COLOR_ATTACHMENT0+oe,r.TEXTURE_2D,0),m(Te)&&f(r.TEXTURE_2D)}t.unbindTexture()}else{let oe=r.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(oe=b.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(oe,K.__webglTexture),ke(oe,v),v.mipmaps&&v.mipmaps.length>0)for(let Ee=0;Ee<v.mipmaps.length;Ee++)ge(F.__webglFramebuffer[Ee],b,v,r.COLOR_ATTACHMENT0,oe,Ee);else ge(F.__webglFramebuffer,b,v,r.COLOR_ATTACHMENT0,oe,0);m(v)&&f(oe),t.unbindTexture()}b.depthBuffer&&$e(b)}function ct(b){const v=b.textures;for(let F=0,K=v.length;F<K;F++){const j=v[F];if(m(j)){const X=E(b),_e=n.get(j).__webglTexture;t.bindTexture(X,_e),f(X),t.unbindTexture()}}}const Ge=[],C=[];function kt(b){if(b.samples>0){if(We(b)===!1){const v=b.textures,F=b.width,K=b.height;let j=r.COLOR_BUFFER_BIT;const X=b.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,_e=n.get(b),oe=v.length>1;if(oe)for(let Te=0;Te<v.length;Te++)t.bindFramebuffer(r.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Te,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,_e.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Te,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer);const Ee=b.texture.mipmaps;Ee&&Ee.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,_e.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let Te=0;Te<v.length;Te++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(j|=r.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(j|=r.STENCIL_BUFFER_BIT)),oe){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,_e.__webglColorRenderbuffer[Te]);const J=n.get(v[Te]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,J,0)}r.blitFramebuffer(0,0,F,K,0,0,F,K,j,r.NEAREST),l===!0&&(Ge.length=0,C.length=0,Ge.push(r.COLOR_ATTACHMENT0+Te),b.depthBuffer&&b.resolveDepthBuffer===!1&&(Ge.push(X),C.push(X),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,C)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Ge))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),oe)for(let Te=0;Te<v.length;Te++){t.bindFramebuffer(r.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Te,r.RENDERBUFFER,_e.__webglColorRenderbuffer[Te]);const J=n.get(v[Te]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,_e.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Te,r.TEXTURE_2D,J,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const v=b.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[v])}}}function qe(b){return Math.min(i.maxSamples,b.samples)}function We(b){const v=n.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function ye(b){const v=a.render.frame;h.get(b)!==v&&(h.set(b,v),b.update())}function at(b,v){const F=b.colorSpace,K=b.format,j=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||F!==Ai&&F!==Pn&&(Ze.getTransfer(F)===it?(K!==Wt||j!==an)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),v}function ve(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=k,this.setTexture2D=$,this.setTexture2DArray=W,this.setTexture3D=ee,this.setTextureCube=H,this.rebindTextures=Re,this.setupRenderTarget=pt,this.updateRenderTargetMipmap=ct,this.updateMultisampleRenderTarget=kt,this.setupDepthRenderbuffer=$e,this.setupFrameBufferTexture=ge,this.useMultisampledRTT=We}function dg(r,e){function t(n,i=Pn){let s;const a=Ze.getTransfer(i);if(n===an)return r.UNSIGNED_BYTE;if(n===Da)return r.UNSIGNED_SHORT_4_4_4_4;if(n===Ua)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Ll)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Pl)return r.BYTE;if(n===Il)return r.SHORT;if(n===Ki)return r.UNSIGNED_SHORT;if(n===La)return r.INT;if(n===Qn)return r.UNSIGNED_INT;if(n===Qt)return r.FLOAT;if(n===es)return r.HALF_FLOAT;if(n===Dl)return r.ALPHA;if(n===Ul)return r.RGB;if(n===Wt)return r.RGBA;if(n===$i)return r.DEPTH_COMPONENT;if(n===ji)return r.DEPTH_STENCIL;if(n===Na)return r.RED;if(n===Fa)return r.RED_INTEGER;if(n===Nl)return r.RG;if(n===Ba)return r.RG_INTEGER;if(n===Oa)return r.RGBA_INTEGER;if(n===Us||n===Ns||n===Fs||n===Bs)if(a===it)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Us)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ns)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Fs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Us)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ns)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Fs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Bs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Qr||n===ea||n===ta||n===na)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Qr)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ea)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ta)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===na)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ia||n===sa||n===ra)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ia||n===sa)return a===it?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===ra)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===aa||n===oa||n===la||n===ca||n===ha||n===ua||n===da||n===fa||n===pa||n===ma||n===ga||n===_a||n===va||n===xa)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===aa)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===oa)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===la)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ca)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ha)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ua)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===da)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===fa)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===pa)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ma)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ga)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===_a)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===va)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===xa)return a===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Os||n===ya||n===Sa)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Os)return a===it?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ya)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Sa)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Fl||n===Ma||n===wa||n===Ea)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Os)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ma)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===wa)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ea)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Zi?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const fg=`
void main() {
