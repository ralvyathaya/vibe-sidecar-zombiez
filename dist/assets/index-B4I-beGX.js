...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function il(){return new Ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Za(),fragmentShader:`
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function sl(){return new Ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Za(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Vm(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Tl?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===yc?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===un&&(e="SHADOWMAP_TYPE_VSM"),e}function Hm(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Si:case Ei:e="ENVMAP_TYPE_CUBE";break;case Xs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Gm(s){let e="ENVMAP_MODE_REFLECTION";return s.envMap&&s.envMapMode===Ei&&(e="ENVMAP_MODE_REFRACTION"),e}function Wm(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case wl:e="ENVMAP_BLENDING_MULTIPLY";break;case zc:e="ENVMAP_BLENDING_MIX";break;case kc:e="ENVMAP_BLENDING_ADD";break}return e}function Xm(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function qm(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Vm(t),c=Hm(t),h=Gm(t),d=Wm(t),u=Xm(t),p=Dm(t),g=Um(r),_=i.createProgram();let m,f,b=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const E=b+m+a,M=b+f+o,P=ul(i,i.VERTEX_SHADER,E),w=ul(i,i.FRAGMENT_SHADER,M);i.attachShader(_,P),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(I){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(_).trim(),O=i.getShaderInfoLog(P).trim(),G=i.getShaderInfoLog(w).trim();let Z=!0,W=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Z=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,P,w);else{const Q=pl(i,P,"vertex"),H=pl(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function lg(s,e,t){let n=new Ga;const i=new Le,r=new Le,a=new Ke,o=new ad({depthPacking:Jc}),l=new od,c={},h=t.maxTextureSize,d={[In]:Pt,[Pt]:In,[fn]:fn},u=new Ln({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Le},radius:{value:4}},vertexShader:ag,fragmentShader:og}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const g=new It;g.setAttribute("position",new Gt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new be(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Tl;let f=this.type;this.render=function(w,R,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const S=s.getRenderTarget(),x=s.getActiveCubeFace(),I=s.getActiveMipmapLevel(),k=s.state;k.setBlending(Cn),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const O=f!==un&&this.type===un,G=f===un&&this.type!==un;for(let Z=0,W=w.length;Z<W;Z++){const Q=w[Z],H=Q.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;i.copy(H.mapSize);const se=H.getFrameExtents();if(i.multiply(se),r.copy(H.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/se.x),i.x=r.x*se.x,H.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/se.y),i.y=r.y*se.y,H.mapSize.y=r.y)),H.map===null||O===!0||G===!0){const ve=this.type!==un?{minFilter:Ft,magFilter:Ft}:{};H.map!==null&&H.map.dispose(),H.map=new $n(i.x,i.y,ve),H.map.texture.name=Q.name+".shadowMap",H.camera.updateProjectionMatrix()}s.setRenderTarget(H.map),s.clear();const de=H.getViewportCount();for(let ve=0;ve<de;ve++){const Oe=H.getViewport(ve);a.set(r.x*Oe.x,r.y*Oe.y,r.x*Oe.z,r.y*Oe.w),k.viewport(a),H.updateMatrices(Q,ve),n=H.getFrustum(),M(R,L,H.camera,Q,this.type)}H.isPointLightShadow!==!0&&this.type===un&&b(H,L),H.needsUpdate=!1}f=this.type,m.needsUpdate=!1,s.setRenderTarget(S,x,I)};function b(w,R){const L=e.update(_);u.defines.VSM_SAMPLES!==w.blurSamples&&(u.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new $n(i.x,i.y)),u.uniforms.shadow_pass.value=w.map.texture,u.uniforms.resolution.value=w.mapSize,u.uniforms.radius.value=w.radius,s.setRenderTarget(w.mapPass),s.clear(),s.renderBufferDirect(R,null,L,u,_,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,s.setRenderTarget(w.map),s.clear(),s.renderBufferDirect(R,null,L,p,_,null)}function E(w,R,L,S){let x=null;const I=L.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(I!==void 0)x=I;else if(x=L.isPointLight===!0?l:o,s.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const k=x.uuid,O=R.uuid;let G=c[k];G===void 0&&(G={},c[k]=G);let Z=G[O];Z===void 0&&(Z=x.clone(),G[O]=Z,R.addEventListener("dispose",P)),x=Z}if(x.visible=R.visible,x.wireframe=R.wireframe,S===un?x.side=R.shadowSide!==null?R.shadowSide:R.side:x.side=R.shadowSide!==null?R.shadowSide:d[R.side],x.alphaMap=R.alphaMap,x.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,x.map=R.map,x.clipShadows=R.clipShadows,x.clippingPlanes=R.clippingPlanes,x.clipIntersection=R.clipIntersection,x.displacementMap=R.displacementMap,x.displacementScale=R.displacementScale,x.displacementBias=R.displacementBias,x.wireframeLinewidth=R.wireframeLinewidth,x.linewidth=R.linewidth,L.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const k=s.properties.get(x);k.light=L}return x}function M(w,R,L,S,x){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&x===un)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,w.matrixWorld);const O=e.update(w),G=w.material;if(Array.isArray(G)){const Z=O.groups;for(let W=0,Q=Z.length;W<Q;W++){const H=Z[W],se=G[H.materialIndex];if(se&&se.visible){const de=E(w,se,S,x);w.onBeforeShadow(s,w,R,L,O,de,H),s.renderBufferDirect(L,null,O,de,w,H),w.onAfterShadow(s,w,R,L,O,de,H)}}}else if(G.visible){const Z=E(w,G,S,x);w.onBeforeShadow(s,w,R,L,O,Z,null),s.renderBufferDirect(L,null,O,Z,w,null),w.onAfterShadow(s,w,R,L,O,Z,null)}}const k=w.children;for(let O=0,G=k.length;O<G;O++)M(k[O],R,L,S,x)}function P(w){w.target.removeEventListener("dispose",P);for(const L in c){const S=c[L],x=w.target.uuid;x in S&&(S[x].dispose(),delete S[x])}}}const cg={[kr]:Vr,[Hr]:Xr,[Gr]:qr,[Mi]:Wr,[Vr]:kr,[Xr]:Hr,[qr]:Gr,[Wr]:Mi};function hg(s,e){function t(){let D=!1;const oe=new Ke;let V=null;const K=new Ke(0,0,0,0);return{setMask:function(ce){V!==ce&&!D&&(s.colorMask(ce,ce,ce,ce),V=ce)},setLocked:function(ce){D=ce},setClear:function(ce,le,De,ht,Mt){Mt===!0&&(ce*=ht,le*=ht,De*=ht),oe.set(ce,le,De,ht),K.equals(oe)===!1&&(s.clearColor(ce,le,De,ht),K.copy(oe))},reset:function(){D=!1,V=null,K.set(-1,0,0,0)}}}function n(){let D=!1,oe=!1,V=null,K=null,ce=null;return{setReversed:function(le){if(oe!==le){const De=e.get("EXT_clip_control");le?De.clipControlEXT(De.LOWER_LEFT_EXT,De.ZERO_TO_ONE_EXT):De.clipControlEXT(De.LOWER_LEFT_EXT,De.NEGATIVE_ONE_TO_ONE_EXT),oe=le;const ht=ce;ce=null,this.setClear(ht)}},getReversed:function(){return oe},setTest:function(le){le?re(s.DEPTH_TEST):Se(s.DEPTH_TEST)},setMask:function(le){V!==le&&!D&&(s.depthMask(le),V=le)},setFunc:function(le){if(oe&&(le=cg[le]),K!==le){switch(le){case kr:s.depthFunc(s.NEVER);break;case Vr:s.depthFunc(s.ALWAYS);break;case Hr:s.depthFunc(s.LESS);break;case Mi:s.depthFunc(s.LEQUAL);break;case Gr:s.depthFunc(s.EQUAL);break;case Wr:s.depthFunc(s.GEQUAL);break;case Xr:s.depthFunc(s.GREATER);break;case qr:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}K=le}},setLocked:function(le){D=le},setClear:function(le){ce!==le&&(oe&&(le=1-le),s.clearDepth(le),ce=le)},reset:function(){D=!1,V=null,K=null,ce=null,oe=!1}}}function i(){let D=!1,oe=null,V=null,K=null,ce=null,le=null,De=null,ht=null,Mt=null;return{setTest:function(Qe){D||(Qe?re(s.STENCIL_TEST):Se(s.STENCIL_TEST))},setMask:function(Qe){oe!==Qe&&!D&&(s.stencilMask(Qe),oe=Qe)},setFunc:function(Qe,Wt,rn){(V!==Qe||K!==Wt||ce!==rn)&&(s.stencilFunc(Qe,Wt,rn),V=Qe,K=Wt,ce=rn)},setOp:function(Qe,Wt,rn){(le!==Qe||De!==Wt||ht!==rn)&&(s.stencilOp(Qe,Wt,rn),le=Qe,De=Wt,ht=rn)},setLocked:function(Qe){D=Qe},setClear:function(Qe){Mt!==Qe&&(s.clearStencil(Qe),Mt=Qe)},reset:function(){D=!1,oe=null,V=null,K=null,ce=null,le=null,De=null,ht=null,Mt=null}}}const r=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap;let h={},d={},u=new WeakMap,p=[],g=null,_=!1,m=null,f=null,b=null,E=null,M=null,P=null,w=null,R=new Ie(0,0,0),L=0,S=!1,x=null,I=null,k=null,O=null,G=null;const Z=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,Q=0;const H=s.getParameter(s.VERSION);H.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(H)[1]),W=Q>=1):H.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),W=Q>=2);let se=null,de={};const ve=s.getParameter(s.SCISSOR_BOX),Oe=s.getParameter(s.VIEWPORT),it=new Ke().fromArray(ve),q=new Ke().fromArray(Oe);function te(D,oe,V,K){const ce=new Uint8Array(4),le=s.createTexture();s.bindTexture(D,le),s.texParameteri(D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(D,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let De=0;De<V;De++)D===s.TEXTURE_3D||D===s.TEXTURE_2D_ARRAY?s.texImage3D(oe,0,s.RGBA,1,1,K,0,s.RGBA,s.UNSIGNED_BYTE,ce):s.texImage2D(oe+De,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,ce);return le}const me={};me[s.TEXTURE_2D]=te(s.TEXTURE_2D,s.TEXTURE_2D,1),me[s.TEXTURE_CUBE_MAP]=te(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),me[s.TEXTURE_2D_ARRAY]=te(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),me[s.TEXTURE_3D]=te(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),re(s.DEPTH_TEST),a.setFunc(Mi),Ge(!1),Ve(io),re(s.CULL_FACE),C(Cn);function re(D){h[D]!==!0&&(s.enable(D),h[D]=!0)}function Se(D){h[D]!==!1&&(s.disable(D),h[D]=!1)}function Ye(D,oe){return d[D]!==oe?(s.bindFramebuffer(D,oe),d[D]=oe,D===s.DRAW_FRAMEBUFFER&&(d[s.FRAMEBUFFER]=oe),D===s.FRAMEBUFFER&&(d[s.DRAW_FRAMEBUFFER]=oe),!0):!1}function Ae(D,oe){let V=p,K=!1;if(D){V=u.get(oe),V===void 0&&(V=[],u.set(oe,V));const ce=D.textures;if(V.length!==ce.length||V[0]!==s.COLOR_ATTACHMENT0){for(let le=0,De=ce.length;le<De;le++)V[le]=s.COLOR_ATTACHMENT0+le;V.length=ce.length,K=!0}}else V[0]!==s.BACK&&(V[0]=s.BACK,K=!0);K&&s.drawBuffers(V)}function ft(D){return g!==D?(s.useProgram(D),g=D,!0):!1}const ot={[Wn]:s.FUNC_ADD,[Sc]:s.FUNC_SUBTRACT,[Ec]:s.FUNC_REVERSE_SUBTRACT};ot[bc]=s.MIN,ot[Tc]=s.MAX;const ke={[wc]:s.ZERO,[Ac]:s.ONE,[Rc]:s.SRC_COLOR,[Or]:s.SRC_ALPHA,[Uc]:s.SRC_ALPHA_SATURATE,[Lc]:s.DST_COLOR,[Pc]:s.DST_ALPHA,[Cc]:s.ONE_MINUS_SRC_COLOR,[zr]:s.ONE_MINUS_SRC_ALPHA,[Dc]:s.ONE_MINUS_DST_COLOR,[Ic]:s.ONE_MINUS_DST_ALPHA,[Nc]:s.CONSTANT_COLOR,[Fc]:s.ONE_MINUS_CONSTANT_COLOR,[Bc]:s.CONSTANT_ALPHA,[Oc]:s.ONE_MINUS_CONSTANT_ALPHA};function C(D,oe,V,K,ce,le,De,ht,Mt,Qe){if(D===Cn){_===!0&&(Se(s.BLEND),_=!1);return}if(_===!1&&(re(s.BLEND),_=!0),D!==Mc){if(D!==m||Qe!==S){if((f!==Wn||M!==Wn)&&(s.blendEquation(s.FUNC_ADD),f=Wn,M=Wn),Qe)switch(D){case vi:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Hi:s.blendFunc(s.ONE,s.ONE);break;case so:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case ro:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case vi:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Hi:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case so:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case ro:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}b=null,E=null,P=null,w=null,R.set(0,0,0),L=0,m=D,S=Qe}return}ce=ce||oe,le=le||V,De=De||K,(oe!==f||ce!==M)&&(s.blendEquationSeparate(ot[oe],ot[ce]),f=oe,M=ce),(V!==b||K!==E||le!==P||De!==w)&&(s.blendFuncSeparate(ke[V],ke[K],ke[le],ke[De]),b=V,E=K,P=le,w=De),(ht.equals(R)===!1||Mt!==L)&&(s.blendColor(ht.r,ht.g,ht.b,Mt),R.copy(ht),L=Mt),m=D,S=!1}function Bt(D,oe){D.side===fn?Se(s.CULL_FACE):re(s.CULL_FACE);let V=D.side===Pt;oe&&(V=!V),Ge(V),D.blending===vi&&D.transparent===!1?C(Cn):C(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);const K=D.stencilWrite;o.setTest(K),K&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),rt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?re(s.SAMPLE_ALPHA_TO_COVERAGE):Se(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ge(D){x!==D&&(D?s.frontFace(s.CW):s.frontFace(s.CCW),x=D)}function Ve(D){D!==vc?(re(s.CULL_FACE),D!==I&&(D===io?s.cullFace(s.BACK):D===xc?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Se(s.CULL_FACE),I=D}function xe(D){D!==k&&(W&&s.lineWidth(D),k=D)}function rt(D,oe,V){D?(re(s.POLYGON_OFFSET_FILL),(O!==oe||G!==V)&&(s.polygonOffset(oe,V),O=oe,G=V)):Se(s.POLYGON_OFFSET_FILL)}function _e(D){D?re(s.SCISSOR_TEST):Se(s.SCISSOR_TEST)}function T(D){D===void 0&&(D=s.TEXTURE0+Z-1),se!==D&&(s.activeTexture(D),se=D)}function v(D,oe,V){V===void 0&&(se===null?V=s.TEXTURE0+Z-1:V=se);let K=de[V];K===void 0&&(K={type:void 0,texture:void 0},de[V]=K),(K.type!==D||K.texture!==oe)&&(se!==V&&(s.activeTexture(V),se=V),s.bindTexture(D,oe||me[D]),K.type=D,K.texture=oe)}function F(){const D=de[se];D!==void 0&&D.type!==void 0&&(s.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Y(){try{s.compressedTexImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function $(){try{s.compressedTexImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function X(){try{s.texSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ge(){try{s.texSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ae(){try{s.compressedTexSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ee(){try{s.compressedTexSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Te(){try{s.texStorage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function j(){try{s.texStorage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ue(){try{s.texImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function we(){try{s.texImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ce(D){it.equals(D)===!1&&(s.scissor(D.x,D.y,D.z,D.w),it.copy(D))}function fe(D){q.equals(D)===!1&&(s.viewport(D.x,D.y,D.z,D.w),q.copy(D))}function He(D,oe){let V=c.get(oe);V===void 0&&(V=new WeakMap,c.set(oe,V));let K=V.get(D);K===void 0&&(K=s.getUniformBlockIndex(oe,D.name),V.set(D,K))}function Ne(D,oe){const K=c.get(oe).get(D);l.get(oe)!==K&&(s.uniformBlockBinding(oe,K,D.__bindingPointIndex),l.set(oe,K))}function st(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},se=null,de={},d={},u=new WeakMap,p=[],g=null,_=!1,m=null,f=null,b=null,E=null,M=null,P=null,w=null,R=new Ie(0,0,0),L=0,S=!1,x=null,I=null,k=null,O=null,G=null,it.set(0,0,s.canvas.width,s.canvas.height),q.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:re,disable:Se,bindFramebuffer:Ye,drawBuffers:Ae,useProgram:ft,setBlending:C,setMaterial:Bt,setFlipSided:Ge,setCullFace:Ve,setLineWidth:xe,setPolygonOffset:rt,setScissorTest:_e,activeTexture:T,bindTexture:v,unbindTexture:F,compressedTexImage2D:Y,compressedTexImage3D:$,texImage2D:ue,texImage3D:we,updateUBOMapping:He,uniformBlockBinding:Ne,texStorage2D:Te,texStorage3D:j,texSubImage2D:X,texSubImage3D:ge,compressedTexSubImage2D:ae,compressedTexSubImage3D:Ee,scissor:Ce,viewport:fe,reset:st}}function dg(s,e,t,n,i,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Le,h=new WeakMap;let d;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(T,v){return p?new OffscreenCanvas(T,v):Yi("canvas")}function _(T,v,F){let Y=1;const $=_e(T);if(($.width>F||$.height>F)&&(Y=F/Math.max($.width,$.height)),Y<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const X=Math.floor(Y*$.width),ge=Math.floor(Y*$.height);d===void 0&&(d=g(X,ge));const ae=v?g(X,ge):d;return ae.width=X,ae.height=ge,ae.getContext("2d").drawImage(T,0,0,X,ge),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+X+"x"+ge+")."),ae}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),T;return T}function m(T){return T.generateMipmaps}function f(T){s.generateMipmap(T)}function b(T){return T.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?s.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function E(T,v,F,Y,$=!1){if(T!==null){if(s[T]!==void 0)return s[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let X=v;if(v===s.RED&&(F===s.FLOAT&&(X=s.R32F),F===s.HALF_FLOAT&&(X=s.R16F),F===s.UNSIGNED_BYTE&&(X=s.R8)),v===s.RED_INTEGER&&(F===s.UNSIGNED_BYTE&&(X=s.R8UI),F===s.UNSIGNED_SHORT&&(X=s.R16UI),F===s.UNSIGNED_INT&&(X=s.R32UI),F===s.BYTE&&(X=s.R8I),F===s.SHORT&&(X=s.R16I),F===s.INT&&(X=s.R32I)),v===s.RG&&(F===s.FLOAT&&(X=s.RG32F),F===s.HALF_FLOAT&&(X=s.RG16F),F===s.UNSIGNED_BYTE&&(X=s.RG8)),v===s.RG_INTEGER&&(F===s.UNSIGNED_BYTE&&(X=s.RG8UI),F===s.UNSIGNED_SHORT&&(X=s.RG16UI),F===s.UNSIGNED_INT&&(X=s.RG32UI),F===s.BYTE&&(X=s.RG8I),F===s.SHORT&&(X=s.RG16I),F===s.INT&&(X=s.RG32I)),v===s.RGB_INTEGER&&(F===s.UNSIGNED_BYTE&&(X=s.RGB8UI),F===s.UNSIGNED_SHORT&&(X=s.RGB16UI),F===s.UNSIGNED_INT&&(X=s.RGB32UI),F===s.BYTE&&(X=s.RGB8I),F===s.SHORT&&(X=s.RGB16I),F===s.INT&&(X=s.RGB32I)),v===s.RGBA_INTEGER&&(F===s.UNSIGNED_BYTE&&(X=s.RGBA8UI),F===s.UNSIGNED_SHORT&&(X=s.RGBA16UI),F===s.UNSIGNED_INT&&(X=s.RGBA32UI),F===s.BYTE&&(X=s.RGBA8I),F===s.SHORT&&(X=s.RGBA16I),F===s.INT&&(X=s.RGBA32I)),v===s.RGB&&F===s.UNSIGNED_INT_5_9_9_9_REV&&(X=s.RGB9_E5),v===s.RGBA){const ge=$?Os:qe.getTransfer(Y);F===s.FLOAT&&(X=s.RGBA32F),F===s.HALF_FLOAT&&(X=s.RGBA16F),F===s.UNSIGNED_BYTE&&(X=ge===nt?s.SRGB8_ALPHA8:s.RGBA8),F===s.UNSIGNED_SHORT_4_4_4_4&&(X=s.RGBA4),F===s.UNSIGNED_SHORT_5_5_5_1&&(X=s.RGB5_A1)}return(X===s.R16F||X===s.R32F||X===s.RG16F||X===s.RG32F||X===s.RGBA16F||X===s.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function M(T,v){let F;return T?v===null||v===Zn||v===Wi?F=s.DEPTH24_STENCIL8:v===jt?F=s.DEPTH32F_STENCIL8:v===Gi&&(F=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Zn||v===Wi?F=s.DEPTH_COMPONENT24:v===jt?F=s.DEPTH_COMPONENT32F:v===Gi&&(F=s.DEPTH_COMPONENT16),F}function P(T,v){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==Ft&&T.minFilter!==tn?Math.log2(Math.max(v.width,v.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?v.mipmaps.length:1}function w(T){const v=T.target;v.removeEventListener("dispose",w),L(v),v.isVideoTexture&&h.delete(v)}function R(T){const v=T.target;v.removeEventListener("dispose",R),x(v)}function L(T){const v=n.get(T);if(v.__webglInit===void 0)return;const F=T.source,Y=u.get(F);if(Y){const $=Y[v.__cacheKey];$.usedTimes--,$.usedTimes===0&&S(T),Object.keys(Y).length===0&&u.delete(F)}n.remove(T)}function S(T){const v=n.get(T);s.deleteTexture(v.__webglTexture);const F=T.source,Y=u.get(F);delete Y[v.__cacheKey],a.memory.textures--}function x(T){const v=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(v.__webglFramebuffer[Y]))for(let $=0;$<v.__webglFramebuffer[Y].length;$++)s.deleteFramebuffer(v.__webglFramebuffer[Y][$]);else s.deleteFramebuffer(v.__webglFramebuffer[Y]);v.__webglDepthbuffer&&s.deleteRenderbuffer(v.__webglDepthbuffer[Y])}else{if(Array.isArray(v.__webglFramebuffer))for(let Y=0;Y<v.__webglFramebuffer.length;Y++)s.deleteFramebuffer(v.__webglFramebuffer[Y]);else s.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&s.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&s.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Y=0;Y<v.__webglColorRenderbuffer.length;Y++)v.__webglColorRenderbuffer[Y]&&s.deleteRenderbuffer(v.__webglColorRenderbuffer[Y]);v.__webglDepthRenderbuffer&&s.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const F=T.textures;for(let Y=0,$=F.length;Y<$;Y++){const X=n.get(F[Y]);X.__webglTexture&&(s.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(F[Y])}n.remove(T)}let I=0;function k(){I=0}function O(){const T=I;return T>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),I+=1,T}function G(T){const v=[];return v.push(T.wrapS),v.push(T.wrapT),v.push(T.wrapR||0),v.push(T.magFilter),v.push(T.minFilter),v.push(T.anisotropy),v.push(T.internalFormat),v.push(T.format),v.push(T.type),v.push(T.generateMipmaps),v.push(T.premultiplyAlpha),v.push(T.flipY),v.push(T.unpackAlignment),v.push(T.colorSpace),v.join()}function Z(T,v){const F=n.get(T);if(T.isVideoTexture&&xe(T),T.isRenderTargetTexture===!1&&T.version>0&&F.__version!==T.version){const Y=T.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{q(F,T,v);return}}t.bindTexture(s.TEXTURE_2D,F.__webglTexture,s.TEXTURE0+v)}function W(T,v){const F=n.get(T);if(T.version>0&&F.__version!==T.version){q(F,T,v);return}t.bindTexture(s.TEXTURE_2D_ARRAY,F.__webglTexture,s.TEXTURE0+v)}function Q(T,v){const F=n.get(T);if(T.version>0&&F.__version!==T.version){q(F,T,v);return}t.bindTexture(s.TEXTURE_3D,F.__webglTexture,s.TEXTURE0+v)}function H(T,v){const F=n.get(T);if(T.version>0&&F.__version!==T.version){te(F,T,v);return}t.bindTexture(s.TEXTURE_CUBE_MAP,F.__webglTexture,s.TEXTURE0+v)}const se={[Zr]:s.REPEAT,[Yn]:s.CLAMP_TO_EDGE,[$r]:s.MIRRORED_REPEAT},de={[Ft]:s.NEAREST,[Kc]:s.NEAREST_MIPMAP_NEAREST,[Qi]:s.NEAREST_MIPMAP_LINEAR,[tn]:s.LINEAR,[nr]:s.LINEAR_MIPMAP_NEAREST,[Kn]:s.LINEAR_MIPMAP_LINEAR},ve={[eh]:s.NEVER,[ah]:s.ALWAYS,[th]:s.LESS,[Ol]:s.LEQUAL,[nh]:s.EQUAL,[rh]:s.GEQUAL,[ih]:s.GREATER,[sh]:s.NOTEQUAL};function Oe(T,v){if(v.type===jt&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===tn||v.magFilter===nr||v.magFilter===Qi||v.magFilter===Kn||v.minFilter===tn||v.minFilter===nr||v.minFilter===Qi||v.minFilter===Kn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(T,s.TEXTURE_WRAP_S,se[v.wrapS]),s.texParameteri(T,s.TEXTURE_WRAP_T,se[v.wrapT]),(T===s.TEXTURE_3D||T===s.TEXTURE_2D_ARRAY)&&s.texParameteri(T,s.TEXTURE_WRAP_R,se[v.wrapR]),s.texParameteri(T,s.TEXTURE_MAG_FILTER,de[v.magFilter]),s.texParameteri(T,s.TEXTURE_MIN_FILTER,de[v.minFilter]),v.compareFunction&&(s.texParameteri(T,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(T,s.TEXTURE_COMPARE_FUNC,ve[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Ft||v.minFilter!==Qi&&v.minFilter!==Kn||v.type===jt&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");s.texParameterf(T,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,i.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function it(T,v){let F=!1;T.__webglInit===void 0&&(T.__webglInit=!0,v.addEventListener("dispose",w));const Y=v.source;let $=u.get(Y);$===void 0&&($={},u.set(Y,$));const X=G(v);if(X!==T.__cacheKey){$[X]===void 0&&($[X]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,F=!0),$[X].usedTimes++;const ge=$[T.__cacheKey];ge!==void 0&&($[T.__cacheKey].usedTimes--,ge.usedTimes===0&&S(v)),T.__cacheKey=X,T.__webglTexture=$[X].texture}return F}function q(T,v,F){let Y=s.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Y=s.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Y=s.TEXTURE_3D);const $=it(T,v),X=v.source;t.bindTexture(Y,T.__webglTexture,s.TEXTURE0+F);const ge=n.get(X);if(X.version!==ge.__version||$===!0){t.activeTexture(s.TEXTURE0+F);const ae=qe.getPrimaries(qe.workingColorSpace),Ee=v.colorSpace===An?null:qe.getPrimaries(v.colorSpace),Te=v.colorSpace===An||ae===Ee?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,v.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,v.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);let j=_(v.image,!1,i.maxTextureSize);j=rt(v,j);const ue=r.convert(v.format,v.colorSpace),we=r.convert(v.type);let Ce=E(v.internalFormat,ue,we,v.colorSpace,v.isVideoTexture);Oe(Y,v);let fe;const He=v.mipmaps,Ne=v.isVideoTexture!==!0,st=ge.__version===void 0||$===!0,D=X.dataReady,oe=P(v,j);if(v.isDepthTexture)Ce=M(v.format===qi,v.type),st&&(Ne?t.texStorage2D(s.TEXTURE_2D,1,Ce,j.width,j.height):t.texImage2D(s.TEXTURE_2D,0,Ce,j.width,j.height,0,ue,we,null));else if(v.isDataTexture)if(He.length>0){Ne&&st&&t.texStorage2D(s.TEXTURE_2D,oe,Ce,He[0].width,He[0].height);for(let V=0,K=He.length;V<K;V++)fe=He[V],Ne?D&&t.texSubImage2D(s.TEXTURE_2D,V,0,0,fe.width,fe.height,ue,we,fe.data):t.texImage2D(s.TEXTURE_2D,V,Ce,fe.width,fe.height,0,ue,we,fe.data);v.generateMipmaps=!1}else Ne?(st&&t.texStorage2D(s.TEXTURE_2D,oe,Ce,j.width,j.height),D&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,j.width,j.height,ue,we,j.data)):t.texImage2D(s.TEXTURE_2D,0,Ce,j.width,j.height,0,ue,we,j.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ne&&st&&t.texStorage3D(s.TEXTURE_2D_ARRAY,oe,Ce,He[0].width,He[0].height,j.depth);for(let V=0,K=He.length;V<K;V++)if(fe=He[V],v.format!==Vt)if(ue!==null)if(Ne){if(D)if(v.layerUpdates.size>0){const ce=jo(fe.width,fe.height,v.format,v.type);for(const le of v.layerUpdates){const De=fe.data.subarray(le*ce/fe.data.BYTES_PER_ELEMENT,(le+1)*ce/fe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,V,0,0,le,fe.width,fe.height,1,ue,De)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,V,0,0,0,fe.width,fe.height,j.depth,ue,fe.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,V,Ce,fe.width,fe.height,j.depth,0,fe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ne?D&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,V,0,0,0,fe.width,fe.height,j.depth,ue,we,fe.data):t.texImage3D(s.TEXTURE_2D_ARRAY,V,Ce,fe.width,fe.height,j.depth,0,ue,we,fe.data)}else{Ne&&st&&t.texStorage2D(s.TEXTURE_2D,oe,Ce,He[0].width,He[0].height);for(let V=0,K=He.length;V<K;V++)fe=He[V],v.format!==Vt?ue!==null?Ne?D&&t.compressedTexSubImage2D(s.TEXTURE_2D,V,0,0,fe.width,fe.height,ue,fe.data):t.compressedTexImage2D(s.TEXTURE_2D,V,Ce,fe.width,fe.height,0,fe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ne?D&&t.texSubImage2D(s.TEXTURE_2D,V,0,0,fe.width,fe.height,ue,we,fe.data):t.texImage2D(s.TEXTURE_2D,V,Ce,fe.width,fe.height,0,ue,we,fe.data)}else if(v.isDataArrayTexture)if(Ne){if(st&&t.texStorage3D(s.TEXTURE_2D_ARRAY,oe,Ce,j.width,j.height,j.depth),D)if(v.layerUpdates.size>0){const V=jo(j.width,j.height,v.format,v.type);for(const K of v.layerUpdates){const ce=j.data.subarray(K*V/j.data.BYTES_PER_ELEMENT,(K+1)*V/j.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,K,j.width,j.height,1,ue,we,ce)}v.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,j.width,j.height,j.depth,ue,we,j.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,Ce,j.width,j.height,j.depth,0,ue,we,j.data);else if(v.isData3DTexture)Ne?(st&&t.texStorage3D(s.TEXTURE_3D,oe,Ce,j.width,j.height,j.depth),D&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,j.width,j.height,j.depth,ue,we,j.data)):t.texImage3D(s.TEXTURE_3D,0,Ce,j.width,j.height,j.depth,0,ue,we,j.data);else if(v.isFramebufferTexture){if(st)if(Ne)t.texStorage2D(s.TEXTURE_2D,oe,Ce,j.width,j.height);else{let V=j.width,K=j.height;for(let ce=0;ce<oe;ce++)t.texImage2D(s.TEXTURE_2D,ce,Ce,V,K,0,ue,we,null),V>>=1,K>>=1}}else if(He.length>0){if(Ne&&st){const V=_e(He[0]);t.texStorage2D(s.TEXTURE_2D,oe,Ce,V.width,V.height)}for(let V=0,K=He.length;V<K;V++)fe=He[V],Ne?D&&t.texSubImage2D(s.TEXTURE_2D,V,0,0,ue,we,fe):t.texImage2D(s.TEXTURE_2D,V,Ce,ue,we,fe);v.generateMipmaps=!1}else if(Ne){if(st){const V=_e(j);t.texStorage2D(s.TEXTURE_2D,oe,Ce,V.width,V.height)}D&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,ue,we,j)}else t.texImage2D(s.TEXTURE_2D,0,Ce,ue,we,j);m(v)&&f(Y),ge.__version=X.version,v.onUpdate&&v.onUpdate(v)}T.__version=v.version}function te(T,v,F){if(v.image.length!==6)return;const Y=it(T,v),$=v.source;t.bindTexture(s.TEXTURE_CUBE_MAP,T.__webglTexture,s.TEXTURE0+F);const X=n.get($);if($.version!==X.__version||Y===!0){t.activeTexture(s.TEXTURE0+F);const ge=qe.getPrimaries(qe.workingColorSpace),ae=v.colorSpace===An?null:qe.getPrimaries(v.colorSpace),Ee=v.colorSpace===An||ge===ae?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,v.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,v.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const Te=v.isCompressedTexture||v.image[0].isCompressedTexture,j=v.image[0]&&v.image[0].isDataTexture,ue=[];for(let K=0;K<6;K++)!Te&&!j?ue[K]=_(v.image[K],!0,i.maxCubemapSize):ue[K]=j?v.image[K].image:v.image[K],ue[K]=rt(v,ue[K]);const we=ue[0],Ce=r.convert(v.format,v.colorSpace),fe=r.convert(v.type),He=E(v.internalFormat,Ce,fe,v.colorSpace),Ne=v.isVideoTexture!==!0,st=X.__version===void 0||Y===!0,D=$.dataReady;let oe=P(v,we);Oe(s.TEXTURE_CUBE_MAP,v);let V;if(Te){Ne&&st&&t.texStorage2D(s.TEXTURE_CUBE_MAP,oe,He,we.width,we.height);for(let K=0;K<6;K++){V=ue[K].mipmaps;for(let ce=0;ce<V.length;ce++){const le=V[ce];v.format!==Vt?Ce!==null?Ne?D&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,0,0,le.width,le.height,Ce,le.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,He,le.width,le.height,0,le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,0,0,le.width,le.height,Ce,fe,le.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,He,le.width,le.height,0,Ce,fe,le.data)}}}else{if(V=v.mipmaps,Ne&&st){V.length>0&&oe++;const K=_e(ue[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,oe,He,K.width,K.height)}for(let K=0;K<6;K++)if(j){Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ue[K].width,ue[K].height,Ce,fe,ue[K].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,He,ue[K].width,ue[K].height,0,Ce,fe,ue[K].data);for(let ce=0;ce<V.length;ce++){const De=V[ce].image[K].image;Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,0,0,De.width,De.height,Ce,fe,De.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,He,De.width,De.height,0,Ce,fe,De.data)}}else{Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Ce,fe,ue[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,He,Ce,fe,ue[K]);for(let ce=0;ce<V.length;ce++){const le=V[ce];Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,0,0,Ce,fe,le.image[K]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,He,Ce,fe,le.image[K])}}}m(v)&&f(s.TEXTURE_CUBE_MAP),X.__version=$.version,v.onUpdate&&v.onUpdate(v)}T.__version=v.version}function me(T,v,F,Y,$,X){const ge=r.convert(F.format,F.colorSpace),ae=r.convert(F.type),Ee=E(F.internalFormat,ge,ae,F.colorSpace),Te=n.get(v),j=n.get(F);if(j.__renderTarget=v,!Te.__hasExternalTextures){const ue=Math.max(1,v.width>>X),we=Math.max(1,v.height>>X);$===s.TEXTURE_3D||$===s.TEXTURE_2D_ARRAY?t.texImage3D($,X,Ee,ue,we,v.depth,0,ge,ae,null):t.texImage2D($,X,Ee,ue,we,0,ge,ae,null)}t.bindFramebuffer(s.FRAMEBUFFER,T),Ve(v)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Y,$,j.__webglTexture,0,Ge(v)):($===s.TEXTURE_2D||$>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,Y,$,j.__webglTexture,X),t.bindFramebuffer(s.FRAMEBUFFER,null)}function re(T,v,F){if(s.bindRenderbuffer(s.RENDERBUFFER,T),v.depthBuffer){const Y=v.depthTexture,$=Y&&Y.isDepthTexture?Y.type:null,X=M(v.stencilBuffer,$),ge=v.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ae=Ge(v);Ve(v)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,ae,X,v.width,v.height):F?s.renderbufferStorageMultisample(s.RENDERBUFFER,ae,X,v.width,v.height):s.renderbufferStorage(s.RENDERBUFFER,X,v.width,v.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,ge,s.RENDERBUFFER,T)}else{const Y=v.textures;for(let $=0;$<Y.length;$++){const X=Y[$],ge=r.convert(X.format,X.colorSpace),ae=r.convert(X.type),Ee=E(X.internalFormat,ge,ae,X.colorSpace),Te=Ge(v);F&&Ve(v)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Te,Ee,v.width,v.height):Ve(v)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Te,Ee,v.width,v.height):s.renderbufferStorage(s.RENDERBUFFER,Ee,v.width,v.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Se(T,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,T),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=n.get(v.depthTexture);Y.__renderTarget=v,(!Y.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Z(v.depthTexture,0);const $=Y.__webglTexture,X=Ge(v);if(v.depthTexture.format===Xi)Ve(v)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,$,0,X):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,$,0);else if(v.depthTexture.format===qi)Ve(v)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,$,0,X):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function Ye(T){const v=n.get(T),F=T.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==T.depthTexture){const Y=T.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Y){const $=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Y.removeEventListener("dispose",$)};Y.addEventListener("dispose",$),v.__depthDisposeCallback=$}v.__boundDepthTexture=Y}if(T.depthTexture&&!v.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");const Y=T.texture.mipmaps;Y&&Y.length>0?Se(v.__webglFramebuffer[0],T):Se(v.__webglFramebuffer,T)}else if(F){v.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(s.FRAMEBUFFER,v.__webglFramebuffer[Y]),v.__webglDepthbuffer[Y]===void 0)v.__webglDepthbuffer[Y]=s.createRenderbuffer(),re(v.__webglDepthbuffer[Y],T,!1);else{const $=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,X=v.__webglDepthbuffer[Y];s.bindRenderbuffer(s.RENDERBUFFER,X),s.framebufferRenderbuffer(s.FRAMEBUFFER,$,s.RENDERBUFFER,X)}}else{const Y=T.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(s.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=s.createRenderbuffer(),re(v.__webglDepthbuffer,T,!1);else{const $=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,X=v.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,X),s.framebufferRenderbuffer(s.FRAMEBUFFER,$,s.RENDERBUFFER,X)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function Ae(T,v,F){const Y=n.get(T);v!==void 0&&me(Y.__webglFramebuffer,T,T.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),F!==void 0&&Ye(T)}function ft(T){const v=T.texture,F=n.get(T),Y=n.get(v);T.addEventListener("dispose",R);const $=T.textures,X=T.isWebGLCubeRenderTarget===!0,ge=$.length>1;if(ge||(Y.__webglTexture===void 0&&(Y.__webglTexture=s.createTexture()),Y.__version=v.version,a.memory.textures++),X){F.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer[ae]=[];for(let Ee=0;Ee<v.mipmaps.length;Ee++)F.__webglFramebuffer[ae][Ee]=s.createFramebuffer()}else F.__webglFramebuffer[ae]=s.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer=[];for(let ae=0;ae<v.mipmaps.length;ae++)F.__webglFramebuffer[ae]=s.createFramebuffer()}else F.__webglFramebuffer=s.createFramebuffer();if(ge)for(let ae=0,Ee=$.length;ae<Ee;ae++){const Te=n.get($[ae]);Te.__webglTexture===void 0&&(Te.__webglTexture=s.createTexture(),a.memory.textures++)}if(T.samples>0&&Ve(T)===!1){F.__webglMultisampledFramebuffer=s.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let ae=0;ae<$.length;ae++){const Ee=$[ae];F.__webglColorRenderbuffer[ae]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,F.__webglColorRenderbuffer[ae]);const Te=r.convert(Ee.format,Ee.colorSpace),j=r.convert(Ee.type),ue=E(Ee.internalFormat,Te,j,Ee.colorSpace,T.isXRRenderTarget===!0),we=Ge(T);s.renderbufferStorageMultisample(s.RENDERBUFFER,we,ue,T.width,T.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ae,s.RENDERBUFFER,F.__webglColorRenderbuffer[ae])}s.bindRenderbuffer(s.RENDERBUFFER,null),T.depthBuffer&&(F.__webglDepthRenderbuffer=s.createRenderbuffer(),re(F.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(X){t.bindTexture(s.TEXTURE_CUBE_MAP,Y.__webglTexture),Oe(s.TEXTURE_CUBE_MAP,v);for(let ae=0;ae<6;ae++)if(v.mipmaps&&v.mipmaps.length>0)for(let Ee=0;Ee<v.mipmaps.length;Ee++)me(F.__webglFramebuffer[ae][Ee],T,v,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Ee);else me(F.__webglFramebuffer[ae],T,v,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);m(v)&&f(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ge){for(let ae=0,Ee=$.length;ae<Ee;ae++){const Te=$[ae],j=n.get(Te);t.bindTexture(s.TEXTURE_2D,j.__webglTexture),Oe(s.TEXTURE_2D,Te),me(F.__webglFramebuffer,T,Te,s.COLOR_ATTACHMENT0+ae,s.TEXTURE_2D,0),m(Te)&&f(s.TEXTURE_2D)}t.unbindTexture()}else{let ae=s.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ae=T.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(ae,Y.__webglTexture),Oe(ae,v),v.mipmaps&&v.mipmaps.length>0)for(let Ee=0;Ee<v.mipmaps.length;Ee++)me(F.__webglFramebuffer[Ee],T,v,s.COLOR_ATTACHMENT0,ae,Ee);else me(F.__webglFramebuffer,T,v,s.COLOR_ATTACHMENT0,ae,0);m(v)&&f(ae),t.unbindTexture()}T.depthBuffer&&Ye(T)}function ot(T){const v=T.textures;for(let F=0,Y=v.length;F<Y;F++){const $=v[F];if(m($)){const X=b(T),ge=n.get($).__webglTexture;t.bindTexture(X,ge),f(X),t.unbindTexture()}}}const ke=[],C=[];function Bt(T){if(T.samples>0){if(Ve(T)===!1){const v=T.textures,F=T.width,Y=T.height;let $=s.COLOR_BUFFER_BIT;const X=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ge=n.get(T),ae=v.length>1;if(ae)for(let Te=0;Te<v.length;Te++)t.bindFramebuffer(s.FRAMEBUFFER,ge.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Te,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,ge.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Te,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,ge.__webglMultisampledFramebuffer);const Ee=T.texture.mipmaps;Ee&&Ee.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ge.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ge.__webglFramebuffer);for(let Te=0;Te<v.length;Te++){if(T.resolveDepthBuffer&&(T.depthBuffer&&($|=s.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&($|=s.STENCIL_BUFFER_BIT)),ae){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,ge.__webglColorRenderbuffer[Te]);const j=n.get(v[Te]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,j,0)}s.blitFramebuffer(0,0,F,Y,0,0,F,Y,$,s.NEAREST),l===!0&&(ke.length=0,C.length=0,ke.push(s.COLOR_ATTACHMENT0+Te),T.depthBuffer&&T.resolveDepthBuffer===!1&&(ke.push(X),C.push(X),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,C)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,ke))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ae)for(let Te=0;Te<v.length;Te++){t.bindFramebuffer(s.FRAMEBUFFER,ge.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Te,s.RENDERBUFFER,ge.__webglColorRenderbuffer[Te]);const j=n.get(v[Te]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,ge.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Te,s.TEXTURE_2D,j,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ge.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const v=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[v])}}}function Ge(T){return Math.min(i.maxSamples,T.samples)}function Ve(T){const v=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function xe(T){const v=a.render.frame;h.get(T)!==v&&(h.set(T,v),T.update())}function rt(T,v){const F=T.colorSpace,Y=T.format,$=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||F!==bi&&F!==An&&(qe.getTransfer(F)===nt?(Y!==Vt||$!==nn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),v}function _e(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=k,this.setTexture2D=Z,this.setTexture2DArray=W,this.setTexture3D=Q,this.setTextureCube=H,this.rebindTextures=Ae,this.setupRenderTarget=ft,this.updateRenderTargetMipmap=ot,this.updateMultisampleRenderTarget=Bt,this.setupDepthRenderbuffer=Ye,this.setupFrameBufferTexture=me,this.useMultisampledRTT=Ve}function ug(s,e){function t(n,i=An){let r;const a=qe.getTransfer(i);if(n===nn)return s.UNSIGNED_BYTE;if(n===La)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Da)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Il)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Cl)return s.BYTE;if(n===Pl)return s.SHORT;if(n===Gi)return s.UNSIGNED_SHORT;if(n===Ia)return s.INT;if(n===Zn)return s.UNSIGNED_INT;if(n===jt)return s.FLOAT;if(n===Ki)return s.HALF_FLOAT;if(n===Ll)return s.ALPHA;if(n===Dl)return s.RGB;if(n===Vt)return s.RGBA;if(n===Xi)return s.DEPTH_COMPONENT;if(n===qi)return s.DEPTH_STENCIL;if(n===Ua)return s.RED;if(n===Na)return s.RED_INTEGER;if(n===Ul)return s.RG;if(n===Fa)return s.RG_INTEGER;if(n===Ba)return s.RGBA_INTEGER;if(n===Rs||n===Cs||n===Ps||n===Is)if(a===nt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Rs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Cs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ps)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Is)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Rs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Cs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ps)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Is)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===jr||n===Jr||n===Qr||n===ea)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===jr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Jr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Qr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ea)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ta||n===na||n===ia)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ta||n===na)return a===nt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ia)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===sa||n===ra||n===aa||n===oa||n===la||n===ca||n===ha||n===da||n===ua||n===fa||n===pa||n===ma||n===ga||n===_a)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===sa)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ra)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===aa)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===oa)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===la)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ca)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ha)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===da)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ua)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===fa)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===pa)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ma)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ga)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===_a)return a===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ls||n===va||n===xa)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ls)return a===nt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===va)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===xa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Nl||n===ya||n===Ma||n===Sa)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Ls)return r.COMPRESSED_RED_RGTC1_EXT;if(n===ya)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ma)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Sa)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Wi?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}const fg=`
void main() {
